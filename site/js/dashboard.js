...
const plugins = {
  'opensearch-dashboards': {
    ...
    default: {
      videos: [
        'apps/vis_builder/basic.cy.js',
        'apps/vis_builder/dashboard.cy.js',
        'apps/vis_builder/experimental.cy.js',
        'apps/vis_builder/vis_types/area.cy.js',
        'apps/vis_builder/vis_types/bar.cy.js',
        'apps/vis_builder/vis_types/line.cy.js',
        'apps/vis_builder/vis_types/metric.cy.js',
        'apps/vis_builder/vis_types/table.cy.js',
        'apps/vis_type_table/basic.cy.js',
        'apps/vis_type_table/data.cy.js',
        'apps/vis_type_table/embed.cy.js',
        'apps/vis_type_table/options.cy.js',
        'apps/vis_type_table/split.cy.js',
        'apps/datasource-management-plugin/1_create_datasource.cy.js',
        'apps/datasource-management-plugin/2_datasource_table.cy.js',
        'apps/datasource-management-plugin/3_update_datasource.cy.js',
  ...
  'custom-import-map-dashboards': {
    ...
    default: {
      videos: [
        'documentsLayer.cy.js',
        'import_vector_map_tab.cy.js',
        `opensearchMapLayer.cy.js`,
      ],
    },
  },
  'gantt-chart-dashboards': {
    name: 'ganttChartDashboards',
    default: { videos: ['gantt_ui.cy.js'] },
  },
  ...
  'notifications-dashboards': {
    ...
    default: {
      videos: ['1_email_senders_and_groups.cy.js', '2_channels.cy.js'],
    },
  },
  'observability-dashboards': {
    ...
    default: {
      videos: [
        '0_before.cy.js',
        '1_trace_analytics_dashboard.cy.js',
        '2_trace_analytics_services.cy.js',
        '3_trace_analytics_traces.cy.js',
        '4_panels.cy.js',
        '5_event_analytics.cy.js',
        '6_notebooks.cy.js',
        '7_app_analytics.cy.js',
        '8_after.cy.js',
      ],
    },
  },
